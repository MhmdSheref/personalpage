...
Line after line, and I had created my very own local print page, on this page you could upload your files for printing over the local network, and through some tools like SumatraPDF, I was able to automate the whole process of printing to just being an upload and a click away! No more interruptions to my valuable gaming time. Hurray!
