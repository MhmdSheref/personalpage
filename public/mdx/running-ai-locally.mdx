...
---
AI, or Artificial Intelligence is a very broad term. Yet you see that word everywhere now. It has become an inescapable part of the digital landscape. And while I do have some thoughts on the ethics of its data gathering and usage (more on this in a future blog, possibly?). It's still -no doubt- a useful tool to have in your arsenal. What if I told you that, by the end of this blog, you will be able to deploy your very own generative LLM (such as DeepSeek!). And run it locally, on your own device, without an internet connection. And it's not even hard! But first,

(For this blog post, when I use “AI” I'm referencing generative machine learning based applications, more precisely, LLMs)
